function [rob_mean,Bg,cg,info,Sigma]=rob_pca(Data,components,max_iter,display,Sigma_end,Sigma_start,iter_grad,Bg,cg,rob_mean)
...
if nargin==7
   rob_mean=mean(Data')';
   [u,~,~]=svd(Data-rob_mean*ones(1,size(Data,2)),0);
   Bg=u(:,1:components);
